            ...
            <section id="movie-tile-wrapper">
                <?php
                    ...
                    foreach($sql->fetch() as $col => $movieId):
                        ...
                        ?>
                            <figure id="movie<?=$movieId?>" class="movie-tile" onclick="showFilmDetails('<?=$_SESSION['user']['id']?>', '<?=$movieId?>', '<?=$movieTitle?>', '<?=$movieYear?>', '<?=$movieGenres?>')">
